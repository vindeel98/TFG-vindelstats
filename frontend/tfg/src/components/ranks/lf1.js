...
class RanksLF1 extends Component{
...
translateMinutes = (minutes,games) => {
  ...
  getData = () => {
    axios.get("http://localhost:3001/lf1/rank/pt")
      .then(dataPT => {
        this.setState({dataPT,dataPTisLoaded:true});
      })
     axios.get('http://localhost:3001/lf1/rank/t2s')
      .then(dataT2=>{
        this.setState({dataT2,dataT2isLoaded:true});
      } )
      axios.get('http://localhost:3001/lf1/rank/t3s')
      .then(dataT3=>{
        this.setState({dataT3,dataT3isLoaded:true});
      } )
      axios.get('http://localhost:3001/lf1/rank/rt')
      .then(dataRT=>{
        this.setState({dataRT,dataRTisLoaded:true});
      } )
      axios.get('http://localhost:3001/lf1/rank/asst')
      .then(dataASST=>{
        this.setState({dataASST,dataASSTisLoaded:true});
      } )
      axios.get('http://localhost:3001/lf1/rank/br')
      .then(dataBR=>{
        this.setState({dataBR,dataBRisLoaded:true});
      } )
      axios.get('http://localhost:3001/lf1/rank/tf')
      .then(dataTF=>{
        this.setState({dataTF,dataTFisLoaded:true});
      } )
      axios.get('http://localhost:3001/lf1/rank/mt')
      .then(dataMT=>{
