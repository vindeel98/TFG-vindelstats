...
class RanksEba extends Component{
...
translateMinutes = (minutes,games) => {
  ...
  getData = () => {
    axios.get("http://localhost:3001/eba/rank/pt")
      .then(dataPT => {
        this.setState({dataPT,dataPTisLoaded:true});
      })
     axios.get('http://localhost:3001/eba/rank/t2s')
      .then(dataT2=>{
        this.setState({dataT2,dataT2isLoaded:true});
      } )
      axios.get('http://localhost:3001/eba/rank/t3s')
      .then(dataT3=>{
        this.setState({dataT3,dataT3isLoaded:true});
      } )
      axios.get('http://localhost:3001/eba/rank/rt')
      .then(dataRT=>{
        this.setState({dataRT,dataRTisLoaded:true});
      } )
      axios.get('http://localhost:3001/eba/rank/asst')
      .then(dataASST=>{
        this.setState({dataASST,dataASSTisLoaded:true});
      } )
      axios.get('http://localhost:3001/eba/rank/br')
      .then(dataBR=>{
        this.setState({dataBR,dataBRisLoaded:true});
      } )
      axios.get('http://localhost:3001/eba/rank/tf')
      .then(dataTF=>{
        this.setState({dataTF,dataTFisLoaded:true});
      } )
      axios.get('http://localhost:3001/eba/rank/mt')
      .then(dataMT=>{
